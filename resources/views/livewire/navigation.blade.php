      ...
      <div class="relative flex items-center justify-between h-16">
        ...
        <div class="flex-1 flex items-center justify-center sm:items-stretch sm:justify-start">
          ...
          <a href="/" class="flex-shrink-0 flex items-center">
            {{-- asset(logo.png);  URL/public/logo.png --}}
            {{-- asset(images/logo.png);  URL/public/images/logo.png --}}
            <img class="block lg:hidden h-8 w-auto" src="{{asset('logo.png')}}" alt="Workflow">
            <img class="hidden lg:block h-8 w-auto" src="{{asset('logo.png')}}" alt="Workflow">
          </a>

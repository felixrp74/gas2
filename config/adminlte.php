    ...
    */
    ...
    'menu' => [ 
        ...
        [
            'text' => 'Ventas',
            'route'  => 'venta.index',
            'icon' => 'fab fa-fw fa fa-coins',
            'can' => 'admin.venta.create'
        ],  
        [
            'text' => 'Registrar venta',
            'route'  => 'venta.create',
            'icon' => 'fab fa-fw fa fa-dollar-sign',
            'can' => 'admin.venta.create'
        ],  
        // https://fontawesome.com/search?p=3&o=r&m=free
        // [
        ...
        // https://fontawesome.com/search?p=3&o=r&m=free
        ['header' => 'INVENTARIO', 'can' => ''],
        [
            'text' => 'Registrar balon de gas',
            'route'  => 'balon_gas.create',
            'icon' => 'fab fa-fw fa fa-fire',
            'can' => 'admin.venta.create',
            // <i class=""></i>
        ],
        [
            'text' => 'Balones de gas',
            'route'  => 'balon_gas.index',
